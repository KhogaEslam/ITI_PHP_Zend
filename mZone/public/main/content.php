	...
	<div class="container">
		...
		<div class="new_grids">
			<div class="col-md-4 new-gd-left">
				<img src="<?php $this->baseUrl() ?>/images/wed1.jpg" alt=" " />
			...
			<div class="col-md-4 new-gd-middle">
				<div class="new-levis">
					<div class="mid-img">
						<img src="<?php $this->baseUrl() ?>/images/levis1.png" alt=" " />
					</div>
					<div class="mid-text">
				...
				<div class="new-levis">
					...
					<div class="mid-img">
						<img src="<?php $this->baseUrl() ?>/images/dig.jpg" alt=" " />
					</div>
					<div class="clearfix"></div>
				</div>
				<div class="clearfix"></div>
			...
			<div class="col-md-4 new-gd-left">
				<img src="<?php $this->baseUrl() ?>/images/wed2.jpg" alt=" " />
